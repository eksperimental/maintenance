defmodule MaintenanceJob.Unicode do
  ...
  def update(project = :elixir, version, contents) when is_map(contents) do
    if pr_exists?(project, @job, version) do
      ...
      # UTS39
      # Replace IdentifierType.txt by copying original (from https://www.unicode.org/Public/security/VERSION_NUMBER/)
      # Replace confusables.txt by copying original (from https://www.unicode.org/Public/Public/security/VERSION_NUMBER/)
